...
export default function TeamLeadAttendancePage() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            // Team Lead endpoint
            const response = await api.get(`/company/team-lead/attendance?start_date=${fromStr}&end_date=${toStr}`)
            ...
            if (typeof errorMsg === 'string' && errorMsg.includes("User does not belong to a team")) {
                setError("NoTeam")
            } else {
    ...
    const handleExport = () => {
        ...
        link.setAttribute("download", `team_attendance_${format(new Date(), "yyyy-MM-dd")}.csv`)
    ...
    if (error === "NoTeam") {
        return (
            <div className="container mx-auto py-8">
                <h2 className="text-3xl font-bold tracking-tight mb-4">Team Attendance</h2>
                <div className="flex flex-col items-center justify-center p-12 border border-dashed rounded-lg bg-muted/50">
                    ...
                    <p className="text-muted-foreground text-center max-w-sm">
                        You do not currently belong to any team. Please contact your administrator to be assigned to a team to view attendance records.
                    </p>
                </div>
            </div>
        )
        ...
        <div className="container mx-auto py-8">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                <div>
                    ...
                    <p className="text-muted-foreground">Monitor attendance for your team.</p>
                </div>
