...
export default function ManagerLayout({
    ...
    // Protect the route - allow 'manager'
    useEffect(() => {
        if (!isLoading) {
            if (!isAuthenticated) {
                router.push("/login");
        ...
        <div className="flex h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-300">
            ...
            `}>
                <div className="h-16 flex items-center px-6 border-b border-gray-200 dark:border-slate-800">
                    <h1 className="text-xl font-bold text-gray-900 dark:text-white">PeopleOS <span className="text-xs font-normal text-gray-500 uppercase">Manager</span></h1>
                </div>
                ...
                <div className="p-4 border-t border-gray-200 dark:border-slate-800">
                    <div className="flex items-center space-x-3 mb-4 px-2">
                        <div className="w-8 h-8 rounded-full bg-teal-100 dark:bg-teal-900 flex items-center justify-center text-sm font-bold text-teal-700 dark:text-teal-300">
