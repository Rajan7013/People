...
import { Calendar as CalendarIcon, Download, CalendarCheck } from "lucide-react"
...
const columns: ColumnDef<AttendanceRecord>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            if (status === "late") className += " bg-yellow-100 text-yellow-800 hover:bg-yellow-100 border-yellow-200"
            else if (status === "present") className += " bg-green-100 text-green-800 hover:bg-green-100 border-green-200"
            else if (status === "absent") className += " bg-red-100 text-red-800 hover:bg-red-100 border-red-200"
        ...
        <div className="container mx-auto py-8">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                <div>
                    ...
                    <p className="text-muted-foreground">View your attendance history and track your work hours.</p>
                </div>
