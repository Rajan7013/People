    ...
    const columns: ColumnDef<Payslip>[] = [
        ...
        },
        {
            ...
            cell: ({ row }) => {
                ...
                return <Badge variant={status === 'paid' ? 'default' : 'outline'} className="capitalize">{status}</Badge>
            }
        },
        {
            id: "actions",
        ...
        <div className="container mx-auto py-8">
            ...
            <div className="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p className="text-muted-foreground">View your salary history.</p>
                </div>
            ...
            <div className="bg-white dark:bg-zinc-950 rounded-md border">
                {loading ? (
                    <div className="p-8 text-center">Loading payslips...</div>
                ) : (
