...
export default function EditEmployeePage() {
        ...
        const loadData = async () => {
            try {
                const [empRes, deptRes] = await Promise.all([
                    api.get(`/company/admin/employees/${id}`),
                    api.get("/company/admin/departments")
                ])
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Update employee
            // Note: We don't send back email as it shouldn't be changed here easily, or depends on backend policy
            const updatePayload = {
            ...
            await api.put(`/company/admin/employees/${id}`, updatePayload)
